  ...
  async function load() {
    try {
      const [ov, cfg, env, preset, jobsRes] = await Promise.all([
        apiFetch('/api/admin/overview', undefined, true),
        apiFetch('/api/admin/microcap/config', undefined, true),
        apiFetch('/api/admin/microcap/env', undefined, true),
        apiFetch('/api/admin/btt/preset', undefined, true),
        apiFetch('/api/admin/btt/jobs', undefined, true),
      ])
      setOverview(ov)
