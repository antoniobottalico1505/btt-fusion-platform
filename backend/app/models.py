...
class User(Base):
    ...
    evm_wallet_address: Mapped[str] = mapped_column(String(80), default='')
    evm_wallet_chain_id: Mapped[int] = mapped_column(Integer, default=8453)
    evm_wallet_connected_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    evm_wallet_link_message: Mapped[str] = mapped_column(Text, default='')
    evm_wallet_link_signature: Mapped[str] = mapped_column(Text, default='')
    solana_wallet_address: Mapped[str] = mapped_column(String(120), default='')
    solana_wallet_connected_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    solana_wallet_link_message: Mapped[str] = mapped_column(Text, default='')
    solana_wallet_link_signature: Mapped[str] = mapped_column(Text, default='')
